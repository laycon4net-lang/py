...
cv2.rectangle(img, r2[0], r2[1], (255, 0, 255), 3)


c1, c2 = ((r1[0][0] + r1[1][0]) // 2, (r1[0][1] + r1[1][1]) // 2), ((r2[0][0] + r2[1][0]) // 2, (r2[0][1] + r2[1][1]) // 2)
cv2.circle(img, c1, 15, (0, 255, 0), -1)
cv2.circle(img, c2, 15, (255, 0, 0), -1)
cv2.line(img, c1, c2, (0, 255, 255), 3)
...
arrow_s, arrow_e = (w - 50, 20), (w - 50, h - 20)
cv2.arrowedLine(img, arrow_s, arrow_e, (255, 255, 0), 3, tipLength=0.05)
cv2.arrowedLine(img, arrow_e, arrow_s, (255, 255, 0), 3, tipLength=0.05)
cv2.putText(img, f'Height: {h}px', (w - 200, h // 2), font, 0.7, (255, 255, 255), 2)
